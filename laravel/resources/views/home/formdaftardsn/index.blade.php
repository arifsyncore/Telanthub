...
<div class="row">
    <div class="col-lg-6" id="sticky-sidebar" style="background: #87D6F51A;">
        ...
        <div class="col-lg-6" id="main">
            ...
            <form id="form1" action="{{ url('/proses-daftardosen') }}" method="POST">
            @csrf
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-8 col-sm-8">
                            <div class="form-group" style="margin-top:16px; margin-left:50px; font-family: 'Poppins', sans-serif; color:#333333;">
                                <label style="font-weight: 500;">Nomor Induk Dosen Nasional  (NIDN)*</label>
                                <input type="text" class="form-control" name="nidn" placeholder="Masukan NIDN lengkap anda">
                            </div>
                        </div>
                        <div class="col-8 col-sm-8">
                            <div class="form-group" style="margin-top:16px; margin-left:50px; font-family: 'Poppins', sans-serif; color:#333333;">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-8 col-sm-8">
                            <div class="form-group" style="margin-top:16px; margin-left:50px; font-family: 'Poppins', sans-serif; color:#333333;">
                                <label style="font-weight: 500;">Penelitian & Konsentrasi studi*</label>
                                <input type="text" class="form-control" name="penelitian" placeholder="Masukan penelitian anda" aria-describedby="basic-addon1">
                            </div>
                        </div>
                        <div class="col-8 col-sm-8">
