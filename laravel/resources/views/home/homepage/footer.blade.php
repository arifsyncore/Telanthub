...
<footer class="text-center" style="font-family: 'Poppins', sans-serif;">
        ...
        <div class="row mt-3">
          ...
          <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4" style="margin-top: 5vh;">
            ...
            <ul class="nav flex-column" style="font-weight: 500; font-size:12px;">
                ...
                <li class="nav-item mb-2"><a href="https://blog.talenthub.id/" class="nav-link p-0" style="color:#333333;">Blog</a></li>
            </ul>
          </div>
          <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4" style="margin-top: 5vh;">
            ...
            <ul class="nav flex-column" style="font-weight: 500; font-size:12px;">
                <li class="nav-item mb-2"><a href="{{url('/magang-bersertifikat')}}" class="nav-link p-0" style="color:#333333;">Magang Bersertifikat</a></li>
                <li class="nav-item mb-2"><a href="{{url('/talenta-academy')}}" class="nav-link p-0" style="color:#333333;">Talenta Academy</a></li>
            </ul>
          </div>
    ...
    <section style="background-color: #00B7FF">
        <div class="container">
            <div class="row">
                <div class="col-md-2 col-lg-2 col-xl-6 mx-auto">
                    <div class="d-flex align-items-center">
                        <p class="p-3 text-white" style="font-weight:500; font-size:14px;">© 2022 Syncore Talenta Indonesia</p>
                    </div>
                </div>
                <div class="col-md-2 col-lg-2 col-xl-6 mx-auto">
                    <div class="d-flex flex-row justify-content-end align-items-center text-white">
                        <a href="https://www.instagram.com/emagang.id/" style="color: white"><i class="fab fa-instagram p-3"></i></a>
                        <a href="https://www.facebook.com/EMagangid-111151428101035/" style="color: white"><i class="fab fa-facebook-f p-3"></i></a>
                        <a href="#"><i class="fab fa-twitter p-3" style="color: white"></i></a>
                        <a href="#"><i class="fab fa-youtube p-3" style="color: white"></i></a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="number" style="font-weight: 400; font-size:14px;" class="form-control" name="no_telp" placeholder="Masukan nomor telepon anda" aria-describedby="basic-addon1" required>
                            </div>
                        </div>
                    </div>
                </div>
